...
class _UsersListViewState extends State<UsersListView> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<chatsBloc.ChatsBloc, chatsBloc.ChatsState>(
      ...
      child: BlocBuilder<chatsBloc.ChatsBloc, chatsBloc.ChatsState>(
        ...
        builder: (context, state) {
          return Stack(children: [
                      ...
                      if (state.searching == Searching.no) {
                        return FirestorePagination(
                          ...
                          itemBuilder: (context, snapshot, index) {
                            ...
                            final User user = User.fromDocumentSnapshot(
            ...
            if (state.findingChatStatus == chatsBloc.FindingChatStatus.loading)
              Positioned.fill(
                  child: Container(
